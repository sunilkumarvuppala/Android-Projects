 ...
 */
public class GetAppDataAsyncTask extends AsyncTask<String, Void, ArrayList<App>> implements AppFragment.OnFragmentInteractionListener {
    Activity activity;
  ...
  static   ListView listView;
    ...
    protected void onPostExecute(final ArrayList<App> apps) {
        ...
        if (apps != null){
            ...
            listView = (ListView) activity.findViewById(R.id.listView_app);
              adapter = new CustomAdapter(activity,R.layout.row_item_layout,appNames,devNames,releaseDates,prices,categories,images);
           ...
           /*         Intent intent = new Intent(activity,PreviewActivity.class);
                    ...
                    gotonextFragment(apps.get(position).getAppTitle(),apps.get(position).getLargeImage());
    ...
    public void gotonextFragment(String name, String image) {
        activity.getFragmentManager().beginTransaction().replace(R.id.container,new PreviewFragment(activity,name,image),"preview")
                .addToBackStack(null)
                .commit();
    }
}